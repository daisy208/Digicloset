      ...
      <div className="relative aspect-[3/4] bg-gray-100 overflow-hidden">
        {processedPhoto ? (
          <>
            ...
            {/* Pose Keypoints (Debugging) */}
            {poseData?.predictions && (
              <div className="absolute inset-0">
                {poseData.predictions[0].keypoints.map((point: any, idx: number) => (
                  <div
                    key={idx}
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            ...
            <p className="text-sm">Your virtual try-on will appear here</p>
          </div>
        )}
                  ...
                  <div
                    ...
                    style={{
                      width: processingStage.includes('Initializing') ? '20%' :
                             processingStage.includes('Running') ? '50%' :
